...
import { calculateBinobeamStrain, BinobeamInput } from '../domain/binobeam';
...
describe('Binocular Beam Calculator', () => {
  ...
  it('should calculate strain for nominal US geometry', () => {
    const input: BinobeamInput = {
      ...
      distanceBetweenHoles: 2.0, // inches
      radius: 0.375, // inches (3/8")
      beamWidth: 1.0, // inches
      beamHeight: 1.5, // inches (must be >= 2*r + 2*t_min = 2*0.375 + 2*0.05 = 0.85)
    ...
    // For binocular beam, all strains should generally be positive in bending
  ...
  it('should handle smaller hole geometry', () => {
    const input: BinobeamInput = {
      appliedLoad: 5000, // lbf
      distanceBetweenHoles: 2.0, // inches (must be >= 2*width)
      radius: 0.25, // smaller radius
      beamWidth: 0.75, // inches
      beamHeight: 1.2, // inches
      distanceLoadHole: 0,
      minimumThickness: 0.04, // inches
      modulus: 30000, // PSI
      gageLength: 0.4, // shorter gage length
      gageFactor: 2.0,
    };
  ...
  it('should reject height smaller than 2r + 2t_min', () => {
    const input: BinobeamInput = {
      ...
      radius: 0.375, // inches
      beamWidth: 1.0, // inches
      beamHeight: 0.6, // too small (< 2*0.375 + 2*0.05 = 0.85)
      distanceLoadHole: 0,
      minimumThickness: 0.05, // inches
      modulus: 30000, // PSI
      gageLength: 0.5, // inches
