...
interface Props {
  ...
  diameterMm:   number  // column diameter (mm)
...
const DENSITY_OPTIONS: { key: MeshDensity; label: string; nx: number; ny: number; nz: number }[] = [
  ...
  { key: 'fine',   label: 'Fine (12×8×8)',    nx: 12, ny: 8,  nz: 8 },
]
...
export default function RoundSolidColumnFea3DCalc({ loadN, diameterMm, lengthMm, modulusGPa, nu }: Props) {
