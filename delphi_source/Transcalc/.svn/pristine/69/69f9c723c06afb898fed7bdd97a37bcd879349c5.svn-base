...
const
  ...
  (* ************************************************* *)
  (* Span vs. Temperature 2 pt Wire Table Form Object *)
  (* ************************************************* *)
type
  TWireTable2ptForm = class(TForm)
    Panel1: TPanel;
    Image1: TImage;
    Panel2: TPanel;
    ST_Input: TLabel;
...
var
  WireTable2ptForm: TWireTable2ptForm;

implementation

uses MainMenu, convert, Span2pt;
{$R *.DFM}
...
(* ********************************************************************* *)
{ TWireTable2ptForm.FormShow }
procedure TWireTable2ptForm.FormShow(Sender: TObject);
begin
...
(* ********************************************************************* *)
{ TWireTable2ptForm.FormCreate }
procedure TWireTable2ptForm.FormCreate(Sender: TObject);
var
...
begin
  ...
  EB_Input.text := SvsTTwoPtForm.ST_Resistance.caption;
  ST_Answer.caption := '';
end;

(* ********************************************************************* *)
{ TWireTable2ptForm.FormClose }
procedure TWireTable2ptForm.FormClose(Sender: TObject;
...
(* ********************************************************************* *)
{ TWireTable2ptForm.FormActivate }
procedure TWireTable2ptForm.FormActivate(Sender: TObject);
begin
  ST_Type.caption := SvsTTwoPtForm.CB_WireType.text;
  CB_WireTypeChange(Sender);
  if ST_Type.caption = 'Balco' then
  begin
    WireGrid.Row := 13;
  end
  else if ST_Type.caption = 'Copper' then
  begin
    WireGrid.Row := 5;
  end
  else if ST_Type.caption = 'Nickel, pure' then
  begin
    WireGrid.Row := 1;
  end;
  { ReCalculate; }
...
(* ********************************************************************* *)
{ TWireTable2ptForm.ReCalculate }
procedure TWireTable2ptForm.ReCalculate;
const
  MINLENGTH_US = 0.01;
  MAXLENGTH_US = 100.0;
  MINRESIST = 0.01;
...
(* ********************************************************************* *)
{ TWireTable2ptForm.BN_ComputeClick }
procedure TWireTable2ptForm.BN_ComputeClick(Sender: TObject);
begin
  ReCalculate;
end;

(* ********************************************************************* *)
{ TWireTable2ptForm.BN_OKClick }
procedure TWireTable2ptForm.BN_OKClick(Sender: TObject);
begin
...
(* ********************************************************************* *)
{ TWireTable2ptForm.CB_WireTypeChange }
procedure TWireTable2ptForm.CB_WireTypeChange(Sender: TObject);
var
  TheStr: string;
  TheObject: TObject;
  TheWire: TObject;
  ...
  j: integer;
begin
  TheType := SvsTTwoPtForm.CB_WireType.itemindex;
  TheItems := SvsTTwoPtForm.CB_WireType.Items;
  TheObject := TheItems.objects[SvsTTwoPtForm.CB_WireType.itemindex];
  WireID := TheItems.strings[SvsTTwoPtForm.CB_WireType.itemindex];
  TheObject := TheItems.objects
    [SvsTTwoPtForm.CB_WireType.Items.indexof(WireID)];
  ...
  begin
    ...
    WireGage := format('%3.4f', [table[i].AWG]);
...
procedure TWireTable2ptForm.WireGridSelectCell(Sender: TObject; Col,
...
(* ********************************************************************* *)
{ TWireTable2ptForm.BN_HelpClick }
procedure TWireTable2ptForm.BN_HelpClick(Sender: TObject);
begin
