...
begin
  ...
  EB_Input.text := ZeroVsTempDlg.ST_Resistance.caption;
  ST_Answer.caption := '';
end;
...
begin
  ST_Type.caption := ZeroVsTempDlg.CB_WireType.text;
...
var
  ...
  j: integer;
begin
  TheType := ZeroVsTempDlg.CB_WireType.itemindex;
  TheItems := ZeroVsTempDlg.CB_WireType.Items;
  TheObject := TheItems.objects[ZeroVsTempDlg.CB_WireType.itemindex];
  WireID := TheItems.strings[ZeroVsTempDlg.CB_WireType.itemindex];
  TheObject := TheItems.objects
    [ZeroVsTempDlg.CB_WireType.Items.indexof(WireID)];
...
(* ********************************************************************* *)
{ TWireTableForm.CB_WireTypeChange }
procedure TWireTableForm.WireGridSelectCell(Sender: TObject; Col,
